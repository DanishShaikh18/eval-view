...
def test_snapshot_does_not_require_approval_for_init_generated_tests(monkeypatch, tmp_path):
    """Init-generated onboarding drafts should snapshot without a separate approval hop."""
    from evalview.commands.snapshot_cmd import snapshot
    ...
    tests_dir.mkdir()
    (tests_dir / "generated.yaml").write_text(
        """# Auto-generated by: evalview init
name: Generated Case
description: Draft generated by evalview init.
meta:
  generated_by: evalview init
