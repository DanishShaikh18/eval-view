...
Yes. EvalView has a GitHub Action (`hidai25/eval-view@v0.5.0`), proper exit codes, JSON output mode, and PR comment support. It also works with GitLab CI, CircleCI, and any CI system that runs Python. See [CI/CD Integration](CI_CD.md).
