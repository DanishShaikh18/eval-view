...
class AgentTestGenerator:
    ...
    def write_suite(self, result: GenerationResult, out_dir: Path) -> List[Path]:
    ...
    def _generate_thresholds(self, trace: Any) -> Thresholds:
        ...
        max_latency = None
        if trace.metrics.total_latency and trace.metrics.total_latency > 0:
            max_latency = int(trace.metrics.total_latency * 1.25)
